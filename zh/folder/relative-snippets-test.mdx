...
这是一个隐藏的测试页面，用于验证相对路径代码片段导入功能。

---

<div id="test-1-parent-directory-import-snippets">
  ## 测试 1：上级目录导入（`../snippets/`）
</div>

使用 `../snippets/test-snippet-a.mdx` 从 `/snippets/test-snippet-a.mdx` 进行导入：
...
使用绝对路径 `/snippets/icons-optional.mdx` 进行导入：
