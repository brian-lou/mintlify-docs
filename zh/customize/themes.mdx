...
mode: "frame"
keywords: ["主题选择", "Mint", "Maple", "自定义外观样式"]
---
...
<div className="pt-10 pb-24 px-4 px-4 max-w-3xl mx-auto prose prose-gray">
  ...
  <label className="text-lg prose prose-gray dark:prose-invert">自定义文档的外观<br /><br />在 docs.json 中配置 [theme](/zh/organize/settings#param-theme)，并从以下主题中选择其一。</label>

  <br />

  <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 gap-8 not-prose">
    <ThemeCard title="Mint" value="mint" description="经典文档主题，拥有久经考验的布局与熟悉的导航体验。" href="https://mint.mintlify.app" />

    <ThemeCard title="Maple" value="maple" description="现代且简洁的视觉风格，非常适合 AI 和 SaaS 产品。" href="https://maple.mintlify.app" />

    <ThemeCard title="Palm" value="palm" description="精致的金融科技主题，为企业级文档提供高度可定制的体验。" href="https://palm.mintlify.app" />

    <ThemeCard title="Willow" value="willow" description="精简至核心要素，打造专注、无干扰的文档体验。" href="https://willow.mintlify.app" />

    <ThemeCard title="Linden" value="linden" description="复古终端质感与等宽字体，呈现 80 年代黑客美学。" href="https://linden.mintlify.app" />

    <ThemeCard title="Almond" value="almond" description="卡片式内容组织结合极简设计，实现直观易用的导航体验。" href="https://almond.mintlify.app" />

    <ThemeCard title="Aspen" value="aspen" description="为复杂导航和自定义组件精心打造的现代文档主题。" href="https://aspen.mintlify.app" />
  </div>
</div>
