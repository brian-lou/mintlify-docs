...
<div className="pt-10 pb-24 px-4 px-4 max-w-3xl mx-auto prose prose-gray">
  ...
  <label className="text-lg prose prose-gray dark:prose-invert">自定义文档的外观<br /><br />在 docs.json 中将 [theme](/zh/organize/settings#param-theme) 配置为以下任一主题。</label>

  <br />

  <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 gap-8 not-prose">
    <ThemeCard title="Mint" value="mint" description="经典文档主题，采用久经考验的布局和熟悉的导航。" href="https://mint.mintlify.app" />

    <ThemeCard title="Maple" value="maple" description="现代简洁的美学风格，非常适合 AI 和 SaaS 产品。" href="https://maple.mintlify.app" />

    <ThemeCard title="Palm" value="palm" description="精致的金融科技主题，为企业文档提供深度自定义能力。" href="https://palm.mintlify.app" />

    <ThemeCard title="Willow" value="willow" description="回归本质的简约设计，打造无干扰的文档体验。" href="https://willow.mintlify.app" />

    <ThemeCard title="Linden" value="linden" description="复古终端风格，搭配等宽字体，呈现 80 年代黑客美学。" href="https://linden.mintlify.app" />

    <ThemeCard title="Almond" value="almond" description="卡片式组织结合极简设计，带来直观的导航体验。" href="https://almond.mintlify.app" />

    <ThemeCard title="Aspen" value="aspen" description="为复杂导航和自定义组件打造的现代文档主题。" href="https://aspen.mintlify.app" />
  </div>
</div>
