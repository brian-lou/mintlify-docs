...
description: "Intégrez l’IA à vos documents en un clic."
...
Le menu contextuel offre un accès rapide à du contenu optimisé par l’IA et à des intégrations directes avec des outils d’IA populaires. Lorsque les utilisateurs sélectionnent le menu contextuel sur n’importe quelle page, ils peuvent copier le contenu en tant que contexte pour des outils d’IA ou ouvrir des conversations dans ChatGPT, Claude, Perplexity ou un outil personnalisé de votre choix, avec votre documentation déjà chargée comme contexte.
...
|:--------|:------------|:-------------|
| **Copier la page** | `copy` | Copie la page actuelle au format Markdown pour l’utiliser comme contexte dans des outils d’IA |
...
| **Options personnalisées** | Object | Ajoute des options personnalisées au menu contextuel |

<Frame>
    <img 
    src="/images/contextual-menu/contextual-menu.png" 
    alt="Le menu contextuel déployé affichant les éléments de menu Copier la page, Afficher en Markdown, Ouvrir dans ChatGPT et Ouvrir dans Claude." 
  />
</Frame>
...
Ajoutez le champ `contextual` à votre fichier `docs.json`, puis indiquez les options que vous souhaitez y inclure.
...
{
  "title": "Demander une fonctionnalité",
  "description": "Participez à la discussion sur GitHub",
  "icon": "plus",
  "href": "https://github.com/orgs/mintlify/discussions/categories/feature-requests"
}
```
...
```json
{
  ...
  "description": "Partagez cette page sur X",
  "icon": "x",
  "href": {
