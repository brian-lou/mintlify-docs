...
description: "Intégrez des plateformes d'assistance pour le support client."
keywords: ["plateformes d'assistance client", "intégration de service d'assistance", "widgets d'assistance", "support client"]
---
...
Intégrez des widgets d’assistance client à votre documentation. Ajoutez le champ `integrations` à votre fichier `docs.json` avec l’ID d’application ou l’ID de chat correspondant. Consultez la documentation de chaque intégration pour savoir où trouver votre identifiant.