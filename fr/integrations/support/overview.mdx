---
title: "Intégrations pour le support client"
description: "Intégrez des plateformes de support pour l’assistance client."
keywords: ["plateformes de support client", "intégration de help desk", "widgets de support", "assistance client"]
---
...
<div id="enabling-support-integrations">
  ## Activation des intégrations de support
</div>

Intégrez des widgets de support client à votre documentation. Ajoutez le champ `integrations` à votre fichier `docs.json` et renseignez l’ID de votre application ou de votre chat. Consultez la documentation de chaque intégration pour savoir comment trouver votre identifiant.