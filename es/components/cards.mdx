---
title: "Tarjetas"
description: "Destaca los puntos principales o enlaces con diseños e iconos personalizables."
keywords: ["tarjetas", "contenedores visuales"]
---

import IconsOptional from "/snippets/es/icons-optional.mdx";

Utiliza tarjetas para crear contenedores visuales de contenido. Las tarjetas son contenedores flexibles que pueden incluir texto, iconos, imágenes y enlaces.
...
Las tarjetas ofrecen diversas opciones de diseño y estilo para adaptarse a distintas necesidades de contenido.
...
<Card title="Tarjeta de enlace" icon="link" href="/es/components/columns" arrow="true" cta="Haz clic aquí">
  Este es un ejemplo de una tarjeta con un icono y un enlace. Al hacer clic en esta tarjeta, accederás a la página Columns.
</Card>
...
Utiliza el [componente Columns](/es/components/columns) para organizar varias tarjetas una junto a otra. El componente Columns admite entre una y cuatro columnas y se ajusta automáticamente a las pantallas más pequeñas.
