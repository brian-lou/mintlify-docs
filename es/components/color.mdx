---
title: "Color"
description: "Muestra paletas de colores con función de copiar al hacer clic."
keywords: ["color", "paleta", "colores", "sistema de diseño", "hex", "rgb", "rgba", "hsl", "oklch"]
---

Usa el componente Color para mostrar paletas de colores en tu documentación. Los colores pueden mostrarse en una cuadrícula compacta o en una tabla con filas etiquetadas.

<div id="compact-variant">
  ## Variante compacta
</div>

Muestra los colores en un diseño de cuadrícula sencillo con los nombres y valores de los colores.
...
Organiza los colores en filas con etiquetas para la documentación del sistema de diseño.
...
El componente admite todos los formatos de color de CSS, incluidos hex, rgb, rgba, hsl y oklch.
...
Define distintos colores para los modos claro y oscuro mediante un objeto con las propiedades `light` y `dark`.
...
<ResponseField name="variant" type="string" required>
  Estilo de visualización de la paleta de colores. Opciones: `compact` o `table`.
</ResponseField>
...
<ResponseField name="value" type="string | { light: string, dark: string }" required>
  Valor del color en cualquier formato CSS, o un objeto con valores para el modo claro y el modo oscuro.
</ResponseField>