---
title: "Color"
description: "Muestra paletas de colores con función de copia con un clic."
keywords: ["color", "palette", "colors", "design system", "hex", "rgb", "rgba", "hsl", "oklch"]
---

Utiliza el componente Color para mostrar paletas de colores en tu documentación. Los colores pueden mostrarse en una cuadrícula compacta o bien en una tabla con filas etiquetadas.

<div id="compact-variant">
  ## Variante compacta
</div>

Muestra los colores en una cuadrícula sencilla con sus nombres y valores.
...
El componente es compatible con todos los formatos de color de CSS, incluidos hex, rgb, rgba, hsl y oklch.
...
Define distintos colores para el modo claro y el modo oscuro usando un objeto con las propiedades `light` y `dark`.
...
<ResponseField name="variant" type="string" required>
  Modo de visualización de la paleta de colores. Opciones: `compact` o `table`.
</ResponseField>
...
<ResponseField name="children" type="Color.Item" required>
  Elementos de color que se mostrarán en la fila.
</ResponseField>
