...
description: "Integra plataformas de soporte para ofrecer atención al cliente."
keywords: ["plataformas de atención al cliente", "integración con servicio de asistencia", "widgets de soporte", "atención al cliente"]
---
...
Integra widgets de atención al cliente en tu documentación. Agrega el campo `integrations` a tu archivo `docs.json` con el ID de la aplicación o del chat correspondiente. Consulta la documentación de cada integración para obtener instrucciones sobre cómo encontrar tu ID.