...
description: "Conecta plataformas de analítica para hacer un seguimiento de la interacción de los usuarios y del uso de la documentación."
keywords: ["third-party analytics", "engagement tracking", "analytics platforms", "usage tracking"]
---

Haz un seguimiento de cómo los usuarios interactúan con tu documentación conectándola a plataformas de analítica de terceros. Mintlify envía eventos de interacción a los proveedores de analítica que hayas configurado.

<div id="how-analytic-integrations-work">
  ## Cómo funcionan las integraciones de analítica
</div>

Cuando añades integraciones de analítica a tu sitio de documentación, Mintlify realiza el seguimiento de interacciones de los usuarios como vistas de página, consultas de búsqueda, solicitudes en el API playground y envíos de comentarios, y las envía a tus proveedores de analítica. Puedes conectar cualquier cantidad de proveedores de analítica compatibles añadiendo tus claves de API al archivo `docs.json`. Los eventos de analítica se envían a tus proveedores en cuanto los añades a tu configuración, sin necesidad de realizar ninguna otra configuración adicional.
...
Añade las credenciales de tu proveedor de analítica al objeto `integrations` en `docs.json`. Incluye solo las plataformas que quieras usar.

<Note>
  Las integraciones de analítica solo requieren claves de API públicas, que son accesibles para cualquiera que visite tu sitio de documentación. Tus claves de API privadas, que se usan junto con las claves públicas en los proveedores de analítica, deben permanecer privadas. No incluyas claves de API privadas en tu `docs.json`.
</Note>
...
Todos los eventos registrados utilizan el prefijo `docs.`.
...
| :-------------------------------------- | :-------------------------------------------------------------------------------------------------------- |
| `docs.content.view`                     | El usuario visualiza una página. Solo se envía a los proveedores que no registran las vistas de página de forma predeterminada. |
| `docs.content.md.view`                  | El usuario visualiza la versión Markdown de una página.                                                   |
| `docs.navitem.click`                    | El usuario hace clic en un elemento de la navegación del encabezado.                                      |
...
| Nombre del evento                       | Descripción                                                                                               |
| :-------------------------------------- | :-------------------------------------------------------------------------------------------------------- |
| `docs.search.query`                     | El usuario realiza una consulta de búsqueda.                                                              |
...
<div id="code-and-api-playground">
  ### Área de pruebas de código y API
</div>
...
| `docs.api_playground.request`           | El usuario realiza una solicitud a la API en el área de pruebas de la API.                              |
...
| `docs.assistant.source_click`           | El usuario hace clic en una cita en una respuesta de chat.                                                |
...
| `docs.assistant.thumbs_up`              | El usuario hace clic en el botón de comentarios positivos en una respuesta del asistente.                |
| `docs.assistant.thumbs_down`            | El usuario hace clic en el botón de comentarios negativos en una respuesta del asistente.                |
| `docs.assistant.spam_detected`          | El asistente detecta spam en un mensaje del usuario.                                                      |
| `docs.autopilot.suggestion.created`     | El agente crea una sugerencia de documentación.                                                           |
| `docs.autopilot.suggestion.no_suggestion` | El agente determina que no se necesita ninguna actualización de la documentación.                        |
...
| :-------------------------------------- | :-------------------------------------------------------------------------------------------------------- |
| `docs.context_menu.copy_page`           | El usuario copia la página actual como Markdown.                                                          |
| `docs.context_menu.copy_mcp_link`       | El usuario copia el enlace al servidor MCP alojado.                                                      |
| `docs.context_menu.ai_provider_click`   | El usuario hace clic en un proveedor de IA para iniciar una conversación usando la página actual como contexto. |
| `docs.context_menu.install_mcp_server`  | El usuario instala el servidor MCP alojado en los editores de código.                                    |