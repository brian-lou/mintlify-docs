---
title: "Prueba de fragmentos relativos con anidación profunda"
description: "Página de prueba oculta para validar importaciones de fragmentos relativos con anidación profunda"
---

<div id="deep-relative-snippets-test">
  # Prueba de fragmentos relativos profundos
</div>

Esta página está ubicada en `/folder/nested/deep-relative-test.mdx` para probar importaciones relativas con varios niveles de profundidad.

***

<div id="test-1-two-levels-up-snippets">
  ## Prueba 1: Dos niveles hacia arriba (`../../snippets/`)
</div>

Importando desde `/snippets/test-snippet-a.mdx` con `../../snippets/`:
...
<div id="test-2-two-levels-up-with-named-export">
  ## Prueba 2: Dos niveles hacia arriba con exportación con nombre
</div>
...
<div id="test-5-mixed-absolute-path-for-comparison">
  ## Prueba 5: Mixto - ruta absoluta (para comparar)
</div>

Importando mediante una ruta absoluta:
...
<div id="path-resolution-summary">
  ## Resumen de resolución de rutas
</div>

Desde esta página en la ruta `/folder/nested/deep-relative-test.mdx`:
