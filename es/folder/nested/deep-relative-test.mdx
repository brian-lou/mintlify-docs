---
title: "Prueba de fragmentos relativos en profundidad"
...
<div id="deep-relative-snippets-test">
  # Prueba de fragmentos relativos en profundidad
</div>

Esta página se encuentra en `/folder/nested/deep-relative-test.mdx` para probar importaciones relativas de múltiples niveles.

---

<div id="test-1-two-levels-up-snippets">
  ## Prueba 1: Dos niveles más arriba (`../../snippets/`)
</div>
...
<div id="test-2-two-levels-up-with-named-export">
  ## Test 2: Dos niveles hacia arriba con exportación nombrada
</div>
...
<div id="test-4-same-directory-sibling">
  ## Prueba 4: Recurso en el mismo directorio (`./`)
</div>

Importación desde `/folder/nested/deep-snippet.mdx` (mismo directorio):
