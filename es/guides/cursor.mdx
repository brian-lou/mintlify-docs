---
title: "Cursor"
description: "Configura Cursor para que sea tu asistente de escritura."
keywords: ["Cursor", "reglas de Cursor", "reglas del proyecto"]
---
...
Las reglas de Cursor proporcionan un contexto persistente sobre tu documentación, lo que garantiza sugerencias más coherentes con tus estándares y tu estilo.

* Las **reglas del proyecto** se almacenan en tu repositorio de documentación y se comparten con tu equipo.
* Las **reglas de usuario** se aplican a tu entorno personal de Cursor.

Te recomendamos crear reglas de proyecto para tu documentación, para que todas las personas colaboradoras tengan acceso a las mismas reglas.
...
Esta regla proporciona a Cursor el contexto necesario para dar el formato correcto a los componentes de Mintlify y seguir las prácticas recomendadas de redacción técnica.
...
Eres un asistente de escritura con IA especializado en crear documentación técnica excepcional usando los Componentes de Mintlify y siguiendo las mejores prácticas del sector en escritura técnica.
...
- Usa el tiempo presente para estados actuales y el futuro para resultados esperados
- Evita el uso de jerga a menos que sea necesario; define los términos la primera vez que aparezcan
...
- Aplica la divulgación progresiva: conceptos básicos antes que avanzados
...
- Céntrate en los objetivos y resultados del usuario, no en las características del sistema
...
- Escribe pensando en la legibilidad rápida: encabezados claros, listas y espacios en blanco
...
<Tip>
Consejos de expertos, atajos o mejores prácticas que favorecen el éxito del usuario
</Tip>
...
#### Info - Información contextual neutra

<Info>
Información de contexto, antecedentes o anuncios de carácter neutral
</Info>
...
#### CodeGroup con múltiples lenguajes

Ejemplo de un CodeGroup:
...
<Update label="Version 2.1.0" description="Publicado el 15 de marzo de 2024">
...
- Se resolvieron los problemas de tiempo de espera en la autenticación
</Update>

## Estructura de página requerida

Cada página de documentación debe comenzar con un Frontmatter YAML:
...
- Proporciona ejemplos de autenticación con el formato correcto
- Explica todos los códigos de estado HTTP y el manejo de errores
- Cubre los ciclos completos de solicitud/respuesta
...
- Asegura una jerarquía de encabezados correcta comenzando por H2
- Ten en cuenta la navegación por teclado
- Usa contraste de color suficiente en ejemplos y elementos visuales
- Estructura el contenido para facilitar su lectura con encabezados y listas
...
- Usa **CodeGroup** para mostrar el mismo concepto en varios lenguajes de programación
...
Conecta el servidor MCP de Mintlify a Cursor para que pueda buscar en la documentación de Mintlify mientras te ayuda a escribir. Cuando conectas el servidor MCP, Cursor busca en la documentación actualizada de Mintlify para obtener contexto, de modo que no tengas que salir de tu IDE para consultarla.
