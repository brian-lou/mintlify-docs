---
title: "Migrar páginas de API en MDX a navegación OpenAPI"
sidebarTitle: "Migrar de MDX a OAS"
description: "Migra a la generación automatizada de OpenAPI con navegación flexible."
keywords: ["Migración de API", "mint migrate-mdx", "Migración a OpenAPI", "Extensión x-mint"]
---

Si actualmente estás usando páginas MDX individuales para tus endpoints de API, puedes migrar a la generación automática de páginas a partir de tu especificación OpenAPI, manteniendo al mismo tiempo la personalización de las páginas individuales. Esto puede ayudarte a reducir la cantidad de archivos que necesitas mantener y a mejorar la consistencia de la documentación de tu API.

Puedes definir metadatos y contenido para cada endpoint en tu especificación OpenAPI y organizar los endpoints donde quieras en la navegación.
...
<Info>
  ...
  Si tienes varias páginas MDX para el mismo endpoint con contenido diferente, el script usará el contenido de la página que aparezca en último lugar en tu `docs.json`.
...
<Steps>
  <Step title="Prepara tu especificación de OpenAPI.">
    ...
    <Tip>
      Valida tu archivo OpenAPI usando el [Swagger Editor](https://editor.swagger.io/) o la [Mint CLI](https://www.npmjs.com/package/mint).
    </Tip>
  </Step>
...
<Steps>
  <Step title="Prepara tu especificación de OpenAPI.">
    ...
    Para los endpoints cuyo contenido o metadatos quieras personalizar, añade la extensión `x-mint` al endpoint. Consulta la [extensión x-mint](/es/api-playground/openapi-setup#x-mint-extension) para más detalles.
...
Puedes personalizar cómo aparece la documentación de tu API en la navegación.
...
Utiliza pestañas o grupos para organizar las distintas versiones de la API:
...
<div id="when-to-use-individual-mdx-pages">
  ## Cuándo utilizar páginas MDX individuales
</div>
...
* Enfoques experimentales de documentación para endpoints específicos.

Para la mayoría de los casos de uso, la navegación basada en OpenAPI ofrece mejor mantenibilidad y coherencia.